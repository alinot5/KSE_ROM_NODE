...
Conda_list.txt contains a list of all the packages in the Anaconda environment I used to validate the code. Some key packages include: tensorflow, sklearn, pandas, seaborn, numpy, scipy, and matplotlib.
